    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1 sec-heading text-center">
          <p class="message-info">Mari Menjalin silaturahmi antar sesama. Kunjungi Yayasan Fahmil Quran!</p>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="cource-box"><a href="#"><img class="img-responsive" src="images/e3.png" alt=""></a>
            <div class="cource-text">
              <h4>Alamat</h4>
              <p>Kp. Sidamukti, Jl. Rajawali RT. 004
RW. 002 No. 35, Kec. Cilodong Kel.
Sukamaju 16413</p>
            </div>
          </div>
        </div>
  ...
  <div class="section-lg m-bottom10">
    <div class="container">
    <div class="col-md-20 col-md-offset-2 sec-heading text-center">
    
    <div class="col-md-20 col-sm-10 projects"><a href="https://goo.gl/maps/JGZW24uy74LCKLUU6"><img src="images/maps.png" alt="" class="img-responsive">
        <h3>Klik untuk Menuju Google maps</h3>
        </a> </div>
